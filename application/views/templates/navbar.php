<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <img src="<?= base_url('assets/img/pdam_biru.png') ?>" class="navbar-brand ps-3" style="width:45px ;">
    <a class="navbar-brand ps-2 mt-2" href="<?= base_url('dashboard') ?>">
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle fw-bold" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 0.8rem;"><?= $this->session->userdata('nama_lengkap'); ?></a>
