    ...
    <main>
        <div class="container-fluid px-2 mt-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="user" action="<?= base_url('pekerjaan/jabatan/update') ?>" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="hidden" class="form-control" id="id" name="id" value="<?= $jabatan->id_jabatan; ?>">
                        ...
                        <button class="btn btn-primary btn-sm mt-1" name="tambah" type="submit"><i class="fas fa-edit"></i> Update Jabatan</button>
                    </form>
                </div>
            </div>
        </div>
